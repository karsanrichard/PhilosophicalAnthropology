					...
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse ">
							<div class="panel-body">
								...
								<p>Male and female refers to the sex which refers to the biological differences; chromosomes, hormonal profiles, internal and external sex organs.</p>
								<p>At the personal level there is the:-</p>
								<ul>
									<li>Masculine</li>
									<li>Feminine</li>
								</ul>
					...
					<div class="panel panel-default">
						...
						<div id="collapseFour" class="panel-collapse collapse ">
							<div class="panel-body">
								...
								<h4>Greatest Manifestation of Total Self-giving in body and soul</h4>
								<p>The greatest manifestation of total self-giving is through the conservation of ones sexuality to give to <strong>ONE</strong> person in a special and unique way. Preservation of virginity (secondary virginity if necessary) untul I discover that person.</p>
								<p>This person can be a man or a woman which is determined after marriage: this way sexuality is exercised in conjugal love/act with my spouse. It can also be God Himself, this is through apostolic celibacy: this is manifested by not exercising sexuality by conserving it for God alone.</p>
								<h4>True Giving</h4>
								<p>To be able to really give yourself to another person, you need to posses yourself through self-control; this is of feelings and of sexual impulse e.t.c.</p>
								<p>True, total self-giving, only takes place when you give yourself in body and soul to only one person for your entire life, because you have established a mutual bond whereby you belong to each other for life.</p>
								<h4>How to live through a relationship</h4>
								<p>There are various stages in which relationships develop. In this case focus is on the relationships between people who intend to be together or are together. Each of these stages has its own place/ role in developing the relationship. These stages include:-
									<ul>
										<li>Friendship</li>
										<li>Attraction/love</li>
										<li>Engagement</li>
										<li>Marriage</li>
									</ul>
								</p>

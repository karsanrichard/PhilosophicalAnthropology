...
<html>
    ...
    <body class="skin-blue">
        ...
        <!-- Bootstrap -->
        <script src="<?php echo base_url().'assests/bootstrap/js/bootstrap.min.js'?>" type="text/javascript"></script>
        <!-- Morris.js charts -->
        <script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
        <script src="<?php echo base_url().'assests/js/plugins/asap/asap.min.js'?>" type="text/javascript"></script>
        <!-- Sparkline -->

...
<head>
    ...
    <title>Human Freedom and Sexuality</title>
    <!-- Stylesheets -->
    ...
    <link type="text/css" href="<?php echo base_url() ?>assets/icons/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link type="text/css" href="<?php echo base_url() ?>assets/icons/rondo/style.css" rel="stylesheet">
 ...
 <!--                            Portfolio</a></li>
                ...
                <div class="centered">
                    <div class="container">
                        <div class="section-headlines">
                            <h1>
                                Welcome to our Website. GO wild with it. Start with whichever segment you'd like.</h1>
                            <p>
                                This site is fully interactive and as informational as possible.</p>
                        </div>
                        <a href="#jump2" class="btn btn-outline btn-lg">Human Sexuality </a>&nbsp; <a href="#jump6"
                            class="btn btn-outline btn-lg">Human Freedom </a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mixitup">
            <ul id="portfolio" class="unstyled">
                <li class="mix phone">
                    <div>
                        <div class="media-thumb">
                            <img src="<?php echo base_url() ?>assets/img/homepage/beach.jpg">
                ...
                <li class="mix tablet">
                    <div>
                        <div class="media-thumb">
                            <img src="<?php echo base_url() ?>assets/img/homepage/biker.jpg">
                            <div class="media-desc">
                                <div>
                                    <p>
                                        <b>A Project</b></p>
                ...
                <li class="mix desktop">
                    <div>
                        <div class="media-thumb">
                            <img src="<?php echo base_url() ?>assets/img/homepage/girl.jpg">
                            <div class="media-desc">
                                <div>
                                    <p>
                                        <b>A Project</b></p>
                ...
                <li class="mix tablet">
                    <div>
                        <div class="media-thumb">
                            <img src="<?php echo base_url() ?>assets/img/homepage/horse.jpg">
                            <div class="media-desc">
                                <div>
                                    <p>
                                        <b>A Project</b></p>
                ...
                <li class="mix tablet">
                    <div>
                        <div class="media-thumb">
                            <img src="<?php echo base_url() ?>assets/img/homepage/morocco.jpg">
                            <div class="media-desc">
                                <div>
                                    <p>
                                        <b>A Project</b></p>
                ...
                <li class="mix tablet">
                    <div>
                        <div class="media-thumb">
                            <img src="<?php echo base_url() ?>assets/img/homepage/mountain.jpg">
                            <div class="media-desc">
                                <div>
                                    <p>
                                        <b>A Project</b></p>
                ...
                <li class="mix tablet">
                    <div>
                        <div class="media-thumb">
                            <img src="<?php echo base_url() ?>assets/img/homepage/sparrow.jpg">
                            <div class="media-desc">
                                <div>
                                    <p>
                                        <b>A Project</b></p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="person media">
                        <div class="person-avatar pull-left">
                            <img src="<?php echo base_url() ?>assets/img/avatar/avatar-1.jpg" class="avatar  img-circle">
                        </div>
                        <div class="media-body">
                ...
                <div class="col-lg-4">
                    <div class="person media">
                        <div class="person-avatar pull-left">
                            <img src="<?php echo base_url() ?>assets/img/avatar/avatar-2.jpg" class="avatar size-default img-circle">
                        </div>
                        <div class="media-body">
                            <h4 class="person-name">
                                Julia Donga</h4>
            ...
            <div id="carousel-testimonial" class="carousel slide bs-docs-carousel-example">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item">
                        <div class="testimonial media">
                            <div class="testimonial-avatar pull-right hidden-xs	">
                                <img src="<?php echo base_url() ?>assets/img/avatar/avatar-3.jpg" class="avatar size-default img-circle">
                            </div>
                            <div class="testimonial-content media-body">
                                <p class="lead">
                                    It is a long established fact that a reader will be distracted by the readable content
                    ...
                    <div class="item">
                        <div class="testimonial media">
                            <div class="testimonial-avatar pull-right hidden-xs	">
                                <img src="<?php echo base_url() ?>assets/img/avatar/avatar-1.jpg" class="avatar size-default img-circle">
                            </div>
                            <div class="testimonial-content media-body">
                                <p class="lead">
                                    It is a long established fact that a reader will be distracted by the readable content
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    This site was made by some nut busting developers. Feel free to contact us if interested in some kind of work done!
                        </a>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>assets/js/jquery.smooth-scroll.min.js"></script>

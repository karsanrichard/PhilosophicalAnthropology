...
class Uploads
{
     ...
     *
     * @Column(name="upload_id", type="integer", nullable=false)
     * @Id
     ...
     *
     * @Column(name="upload_key", type="string", length=255, nullable=false)
     */
    private $uploadKey;
     ...
     * @var string $fileType
     *
     * @Column(name="file_type", type="string", length=255, nullable=false)
     */
    private $fileType;
     ...
     *
     * @Column(name="uploded_by", type="string", length=255, nullable=false)
     */
    private $uplodedBy;

...
class Instructors
{
     ...
     *
     * @Column(name="second_name", type="string", length=50, nullable=false)
     */
    private $secondName;
     ...
     * @var string $location
     *
     * @Column(name="location", type="string", length=100, nullable=false)
     */
    private $location;
     ...
     * @var string $phone
     *
     * @Column(name="phone", type="string", length=15, nullable=false)
     */
    private $phone;
